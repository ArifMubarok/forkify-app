...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","regenerator-runtime":"dXNgZ"}],"49tUX":[function(require,module,exports) {
...
const loadRecipe = async function(id) {
    try {
        ...
        console.error(`${error} PENTOL GORENG`);
        throw error;
    }
};
...
const KEY = "144bd32a-a007-4674-abcc-47cc898670f4";
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._buttonNext();
        // Last page
        if (curPage === numPages && numPages > 1) return this._buttonPrev();
        // Other page
...
class PreviewView extends (0, _viewJsDefault.default) {
    ...
    _message = "Render was successfully uploaded";
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire6d3a")
